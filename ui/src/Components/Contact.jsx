...
function Contact() {
  ...
  return (
    <>
      <section id="contact">
        <div className="container px-2 sm:px-5 py-5 md:py-10 mx-auto text-center lg:px-40 d-flex flex-wrap">
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-5">
            <div style={{ overflow: 'hidden', maxWidth: '100%', width: '100%', height: '40em', borderRadius: '10px' }} className="p-5">
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-5">
            <form onSubmit={handleSubmit} ref={form}>
              ...
              <p className="leading-relaxed mb-3">
                Ready to collaborate? Get in touch via the form below and let's discuss your project.
                Whether you're looking for a talented developer, a creative problem-solver, or a tech-savvy partner, I'm here to help bring your ideas to life. Share your requirements, and let's embark on a journey to turn your vision into a reality.
              </p>
